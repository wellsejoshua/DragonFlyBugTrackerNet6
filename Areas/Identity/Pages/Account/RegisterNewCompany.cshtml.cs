...
namespace DragonFlyBugTrackerNet6.Areas.Identity.Pages.Account
{
    public class RegisterCompanyModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new AppUser { UserName = Input.Email, Email = Input.Email, FirstName = Input.FirstName, LastName = Input.LastName, CompanyId = companyQuery.Id };
