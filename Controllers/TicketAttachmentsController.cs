...
namespace DragonFlyBugTrackerNet6.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.TicketAttachments.Include(t => t.AppUser).Include(t => t.Ticket);
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,AppUserId,Created,Description,FileName,FileData,FileContentType")] TicketAttachment ticketAttachment)
        {
            ...
            ViewData["AppUserId"] = new SelectList(_context.Users, "Id", "Id", ticketAttachment.AppUserId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,AppUserId,Created,Description,FileName,FileData,FileContentType")] TicketAttachment ticketAttachment)
        {
