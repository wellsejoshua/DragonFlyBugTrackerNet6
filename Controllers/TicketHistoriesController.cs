...
namespace DragonFlyBugTrackerNet6.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.TicketHistories.Include(t => t.AppUser).Include(t => t.Ticket);
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,AppUserId,Property,OldValue,NewValue,Created,Description")] TicketHistory ticketHistory)
        {
            ...
            ViewData["AppUserId"] = new SelectList(_context.Users, "Id", "Id", ticketHistory.AppUserId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,AppUserId,Property,OldValue,NewValue,Created,Description")] TicketHistory ticketHistory)
        {
